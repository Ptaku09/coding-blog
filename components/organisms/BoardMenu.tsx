        ...
        <div className="mt-12 h-full flex justify-between flex-col font-raleway font-[500] text-lg text-gray-500 dark:text-gray-300">
          <ul className="space-y-4">
            <li>
              <Link href="/board">
                <a
                  className={`p-2 flex items-center gap-3 transition-all duration-500 hover:bg-gray-200 dark:hover:bg-zinc-700 ${
            ...
            <li>
              <button
                ...
                className="w-full p-2 flex items-center gap-3 transition-all duration-500 hover:bg-gray-200 dark:hover:bg-zinc-700"
              >
                {theme === 'light' ? (
          ...
          <div>
            <ul className="space-y-4">
              ...
              <li>
                <button
                  onClick={() => signOut()}
                  className="w-full p-2 flex items-center gap-3 transition-all duration-500 hover:bg-red-200 dark:hover:bg-rose-700"
                >
