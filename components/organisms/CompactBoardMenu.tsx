      ...
      <div className="fixed w-20 h-full pt-4 px-2 pb-24">
        ...
        <div className="mt-12 h-full flex justify-between flex-col font-raleway font-[500] text-lg text-gray-500 dark:text-gray-300">
          <ul className="space-y-4">
            <li>
              <Link href="/bookmarks">
                <a className="p-2 flex items-center justify-center justify-center gap-3 transition-all duration-500 hover:bg-gray-200 dark:hover:bg-zinc-700 dark:hover:bg-zinc-700 w-full">
            ...
            <li>
              <Link href="/search">
                <a className="p-2 flex items-center justify-center gap-3 transition-all duration-500 hover:bg-gray-200 dark:hover:bg-zinc-700 w-full">
            ...
            <li>
              <button
                ...
                className="p-2 flex items-center justify-center gap-3 transition-all duration-500 hover:bg-gray-200 dark:hover:bg-zinc-700 w-full"
              >
                {theme === 'light' ? (
          ...
          <div>
            <ul className="space-y-4">
              ...
              <li>
                <button
                  onClick={() => signOut()}
                  className="p-2 flex items-center justify-center gap-3 transition-all duration-500 hover:bg-red-200 dark:hover:bg-rose-700 w-full"
                >
