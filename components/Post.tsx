  ...
  return (
    <div className="w-[32rem] h-[22rem] bg-gradient-to-b from-blue-500 to-purple-600 p-1 font-jakarta">
      <div className="w-full h-full bg-white p-1">
        <div className="w-full h-full px-10 py-5 bg-hero-pattern">
          <div className="flex items-center justify-start gap-5">
            <Image className="rounded-full bg-contain" objectFit="cover" src={avatar} width={70} height={70} alt="avatar" />
            <div>
